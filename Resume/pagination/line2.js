...
div1.setAttribute('id','listingTable');
...
div2.appendChild(a);
a.setAttribute('href','javascript:prevPage()');
a.setAttribute('id','btn_prev');
a.innerText = 'Prev';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(1)');
a.setAttribute('id','num');
a.innerText = '1';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(2)');
a.setAttribute('id','num');
a.innerText = '2';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(3)');
a.setAttribute('id','num');
a.innerText = '3';
...
var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(4)');
a.setAttribute('id','num');
a.innerText = '4';
...
var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(5)');
a.setAttribute('id','num');
a.innerText = '5';
...
var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(6)');
a.setAttribute('id','num');
a.innerText = '6';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(7)');
a.setAttribute('id','num');
a.innerText = '7';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(8)');
a.setAttribute('id','num');
a.innerText = '8';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(9)');
a.setAttribute('id','num');
a.innerText = '9';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:changePage(10)');
a.setAttribute('id','num');
a.innerText = '10';

var a = document.createElement('a');
div2.appendChild(a);
a.setAttribute('href','javascript:nextPage()');
a.setAttribute('id','btn_next');
a.innerText = 'Next';
...
function prevPage()
{
    var current_page = document.getElementById("page").innerText;
    if (current_page > 1) {
        current_page--;
...
function changePage(page)
{
    ...
    for (var i = (page-1) * records_per_page; i < (page * records_per_page); i++) {
        listing_table.innerHTML += objJson[i].id + "<br>";
        listing_table.innerHTML += objJson[i].name + "<br>";
        listing_table.innerHTML += objJson[i].email + "<br>";
    }
